<div class="min-h-screen flex items-center justify-center relative overflow-hidden bg-background">
    ...
    <div class="w-full max-w-md px-6 relative z-10">
        <div class="text-center mb-10">
            ...
            <h1 class="text-2xl font-semibold text-foreground tracking-tight">Buat Akun Baru</h1>
            <p class="text-muted-foreground mt-2 text-sm">Mulai pengalaman Anda bersama kami</p>
        </div>
        ...
        <div class="bg-card/50 backdrop-blur-xl border border-border rounded-2xl p-8 shadow-2xl card-glow">
            ...
            <form wire:submit.prevent="register" class="space-y-4">
                <div>
                    <label class="block text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5 ml-1">Nama Lengkap</label>
                    ...
                    @error('name') <span class="text-destructive text-xs mt-1 ml-1">{{ $message }}</span> @enderror
                </div>
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        <label class="block text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5 ml-1">Kata Sandi</label>
                        <input wire:model="password" type="password" required 
                               class="w-full px-4 py-2.5 rounded-lg bg-secondary/50 border border-border text-foreground text-sm focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all"
                               placeholder="••••••••">
                    </div>
                    <div>
                        <label class="block text-xs font-medium text-muted-foreground uppercase tracking-wider mb-1.5 ml-1">Konfirmasi</label>
                ...
                <button type="submit" class="w-full py-3 mt-4 rounded-lg bg-primary text-primary-foreground font-semibold hover:brightness-110 transition-all">
                    Daftar Akun
                </button>
            </form>
        </div>
