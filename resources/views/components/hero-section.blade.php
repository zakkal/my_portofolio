    ...
    <div x-data="{ shown: false }" x-intersect.once="shown = true" class="section-container relative z-10 text-center py-20">
        <div 
            ...
            <div class="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="{{ asset('cv-zaki-alghifari.pdf') }}" target="_blank" class="inline-flex items-center justify-center gap-2 px-8 py-3.5 rounded-lg border border-primary text-primary font-semibold hover:bg-primary/10 transition-all">
                    Unduh CV
